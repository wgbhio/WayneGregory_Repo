...
$reportBasePath = "C:\Users\GrWay\OneDrive\OneDrive - Beazley Group\Documents\Scripts\Reports"
$reportPath = Join-Path $reportBasePath $scriptName
...
$cred = Get-Credential -UserName "a1_wg7@bfl.local" -Message "Enter password for a1_wg7@bfl.local"
